<div class='container mt-5'> 
	<table class='table table-inverse'>
					...
					<tbody class='bg-dark text-light text-center'>
						<tr>
							<td id="razon_social"><?php echo $resultado['razon_social']; ?></td>
							<td id="cuit"><?php echo $resultado['cuit']; ?></td>
					...
					<div class="row">
						<div class="col-5">
							<h4 class="text-dark">CLIENTE</h4>
				  			<p class="text-dark"><?php echo $resultado['razon_social'];?></p>
						</div>
						<div class="col-4 dniCliente">
							<h4 class="text-dark">CUIT</h4>
				  			<p class="text-dark"><?php echo $resultado['cuit']; ?></p>
						</div>	
						<div class="col-3">
...
<script type="text/javascript" src="razon_social.js"></script>
